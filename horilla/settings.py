...
env = environ.Env(
    ...
    ALLOWED_HOSTS=(list, ["*"]),
    CSRF_TRUSTED_ORIGINS=(list, ["http://localhost:8000","https://d649-2405-201-f011-2855-d052-93d5-1e6-6b8d.ngrok-free.app"]),
)
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "noreply.newenquiry@gmail.com"
EMAIL_HOST_PASSWORD = "qgrlfsttnvhfqekt"
